...
stepp.rnote <- function(){
  ...
  cat("\n2. Tail-oriented window - In addition to the sliding window pattern, the user can now specify")
  ...
  cat("\n3. Updated BIG data and aspirin data - The original de-identified data sets are provided with this")
  ...
  cat("\n4. Cut-Point (or edge identification) - This version contains an experimental feature to identify")
  ...
  cat("\nSoftware for event-based subpopulation analysis is available on: https://sites.google.com/site/stepprpackage/")
